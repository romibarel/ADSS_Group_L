...
public class LocationControllerTest {
    ...
    public void moveProduct() {
        ...
        Assert.assertEquals(locationController.getProductsLocation().get(1).get(date).values().contains(40), true);
        Assert.assertEquals(locationController.getProductsLocation().get(1).get(date).values().contains(60), true);
    }
